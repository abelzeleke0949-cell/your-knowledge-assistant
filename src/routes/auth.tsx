...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — GIS Consultancy Admin" },
      { name: "description", content: "Sign in to manage the GIS Consultancy knowledge base." },
    ],
  }),
  component: AuthPage,
});
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle>GIS Consultancy Admin</CardTitle>
          <CardDescription>
            {mode === "signup" ? "Create the first admin account" : "Sign in to manage the assistant"}
          </CardDescription>
        </CardHeader>
        <CardContent>
